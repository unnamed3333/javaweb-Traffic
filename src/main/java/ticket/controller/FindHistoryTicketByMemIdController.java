...
@WebServlet("/Ticket/FindHistoryTicketByMemId/*")
public class FindHistoryTicketByMemIdController extends HttpServlet {
...
//	讓兩邊時間格式一樣
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			List<Ticket> list = SERVICE.findTicketByMemIdHistory(Integer.valueOf(id)); // 把從前端取得的member傳進service
